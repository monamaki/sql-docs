...
1. Download the latest **sqlmlutils** file (`.zip` for Windows, `.tar.gz` for Linux) from [https://github.com/microsoft/sqlmlutils/releases](https://github.com/Microsoft/sqlmlutils/tree/master/R/dist). Don't expand the file.
